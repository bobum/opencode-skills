...
description: Provides guidance for property-based testing across multiple languages. Use when writing tests for serialization/validation/parsing patterns, or when property-based testing would provide stronger coverage than example-based tests.
license: AGPL-3.0
metadata:
