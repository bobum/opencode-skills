---
name: qa-regression
description: Automate QA regression testing with reusable Playwright test skills. Create login flows, dashboard checks, user creation, and other common test scenarios that run consistently.
license: MIT
metadata:
